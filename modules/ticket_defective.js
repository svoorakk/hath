...
//////////////////////////////////////////////////////////////////
//Ticket
function Ticket(maxNo, rows, cols, numberCount) {
  this.rows = rows||3;
  this.cols = cols||9;
  this.maxNo = maxNo || 90;
  this.numberCount = numberCount || 15;
  this.numCollection = new Array(this.cols);
  var nums_per_row = Math.ceil(this.numberCount / this.rows); 
  console.log('nums_per_row', nums_per_row);
